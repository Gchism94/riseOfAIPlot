...
plot <- data |>
  ...
  labs(x = NULL, #<22>
       ...
       title = "<span style='color:#5b5b5b;'><b>The rise of artificial intelligence over the last 8 decades:</b> As training<br>computation has increased, AI systems have become more powerful</span>" #<24>
       ) + 
  theme(legend.position = c(0.357, 0.985), #<25>
        legend.direction = "horizontal", #<26>
        legend.spacing.x = unit(-0.1,'cm'), #<27>
        legend.title = element_markdown(family = "Open Sans", size = 10, color = "#5b5b5b"), #<28>
        legend.text = element_markdown(family = "Open Sans"), #<29>
        plot.title = element_markdown(hjust = 0.2275, vjust = 0.99, size = 18.5, family = "Playfair Display"), #<30>
        plot.title.position = "plot", #<31>
        plot.margin = margin(t = 0, r = 0, b = -1, l = 10), #<32>
